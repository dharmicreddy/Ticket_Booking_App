<?php 
  ...
  // SQL query to select movie details and group them by release date in descending order
  $query1 = "select movie_id, movie_name, movie_description, movie_logo, movie_releasedate, movie_rating, movie_time from movies GROUP BY movie_releasedate DESC";
...
<html lang="en" dir="ltr">
  ...
  <body style="overflow-x: hidden; background-color:white;">
    ...
    <!-- Main content: List of latest movies -->
    <br>
    <center><h3><u>List of Latest Movies</u></h3></center>
